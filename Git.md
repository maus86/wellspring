...
### 3.1. Стартуем проект из [шаблона](https://github.com/maus86/maus86-project-template):

* `git clone git@github.com:maus86/maus86-project-template.git new-project && cd new-project` - клонируем в папку `new-project` и переход в неё.
