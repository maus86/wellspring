...
```html
<!-- Плохо -->
<div class="block"><div class="block__element">Content</div></div>
...
- После закрывающихся тегов не должно быть лишних пробелов и/или табов. Для автоудаления можно настроить свой редактор кода. Для Sublime Text можно посмотреть в репе [sputnik](https://github.com/Content/sputnik/wiki/Софт).
```html
<!-- Плохо -->
<div class="block">∙
  <div class="block__element">Content</div>∙∙∙∙
...
- Для страниц сайта, находящихся в поддиректории (обычно на хостинге Content или заказчика).
...
<img class="logo" src="images/logo.png" alt="Content">
```
...
<input id="skype" name="skype" value="Content.ru">
```
...
```html
<!-- Плохо -->
<a href="#">Портфолио Content</a>

<!-- Хорошо -->
<a href="javascript:void(0);">Портфолио Content</a>
```
...
- Телефоны, email-адреса и Skype-контакт должны быть ссылками:
	...
	- `mailto:sales@Content.com` - для указания e-mail.
	- `skype:Content.ru?chat` - для указания Skype-контакта.

```html
<a href="tel:+79876543210">+7-987-654-32-10</a>
<a href="mailto:sales@Content.com">Напишите нам на почту</a>
<a href="skype:Content.ru?chat">Напишите нам в Skype</a>
```
...
<!-- Неплохо -->
<span class="avatar">
	<img src="avatars/Content.png" alt="Content">
</span>

<!-- Лучше -->
<img class="avatar" src="avatars/Content.png" alt="Content">
```
...
<img src="images/Content.png" alt="Content" width="128" height="64">
```
